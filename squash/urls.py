...
urlpatterns = patterns('squash.views',
    ...
    url(r'^reopen/(?P<project_key>\w+)/(?P<issue_num>\d+)/$', 'reopen_issue'),
    ...
    url(r'^newComment/(?P<project_key>\w+)/(?P<issue_num>\d+)/$', 'create_comment'),
    ...
    url(r'^editVersion/save/$', 'save_version'),
    url(r'^editVersion/(?P<project_key>\w+)/(?P<version_num>((\d+).)+(\d+))/$', 'edit_version'),
    ...
    url(r'^confirmDeleteUser/(?P<username>\w+)/$', 'confirm_delete_user'),
    url(r'^deleteUser/(?P<username>\w+)/$', 'delete_user'),
